...
public class OrderServiceTest {
    ...
    public void setUp() {
        ...
        placedOrder = new Order(1L, OrderStatus.PLACED, LocalDateTime.now(), bunny);
        delivredOrder = new Order(2L, OrderStatus.DELIVERED, LocalDateTime.now(), chocky);
    ...
    public void CreateOrder() {
        ...
        OrderDTO orderDTO = orderService.create(1L);
