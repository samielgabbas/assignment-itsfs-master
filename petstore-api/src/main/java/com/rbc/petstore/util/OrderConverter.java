...
public class OrderConverter {
    ...
    public OrderDTO toDto(Order order){
        return new OrderDTO(order.getId(), order.getShipDate(), order.getStatus(), order.getPet().getId());
    }
    ...
    public Order fromDto(OrderDTO orderDTO){
        ...
        return new Order(orderDTO.getId(), orderDTO.getStatus(), orderDTO.getShipDate(), pet);
    }
}
